  ...
  return (
    <article className="info-page">
      ...
      <p>
        ...
        generated signature image to our server. Export actions such as PNG, SVG, and copy-to-
        clipboard are handled in the browser.
      </p>

      <h2>Third-party services</h2>
      <p>
        The site loads fonts from Google Fonts so the handwritten and multilingual styles can be
        displayed correctly. The language helper may request approximate location data from IP
        lookup services to suggest a suitable language. Cloudflare may process standard web
        request data to deliver and protect the site.
      </p>

      <h2>Cookies and accounts</h2>
      <p>
        The signature generator does not require login accounts or payment details. The site may
        use browser storage for interface behavior such as remembering whether a language
        suggestion has already been shown during a session.
      </p>
